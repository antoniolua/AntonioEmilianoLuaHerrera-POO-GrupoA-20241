    ...
    public static void ejecutarMenuGerente(){
        ...
        do {
            ...
            switch (opc) {
                ...
                case 3:
                    System.out.println("Opción 3 seleccionada.");
                    System.out.println("***ACTUALIZAR EL SUELDO DEL TRABAJADOR***");
                    Usuario.actualizarDatosComunes();
                    break;
                case 4:
                    sc.nextLine();
                    System.out.println("Opción 4 seleccionada");
                    ...
                    biblioteca.eliminarUsuario(nombreUsuario);
                    break;
                case 5:
                    System.out.println("Opción 5 seleccionada");
                    break;
